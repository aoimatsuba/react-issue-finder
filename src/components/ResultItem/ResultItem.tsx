...
const ResultItem: React.FunctionComponent<Props> = (props: Props) => {
        ...
        <div className="result-item__container">
            <Card>
                <Card.Header className="result-item__header">
                    <div className="result-item__header__numberAndLabels">
                        ...
                        <div className="result-item__header__labels">
                            {props.issue.labels?.edges.map((label) => (
                                <span
                                    className="badge badge-pill label"
                    ...
                    {!props.isDetail && (
                        <Link to={`/detail/${props.issue.number}`} target="_blank">
                            <Button className="result-item__header__expandLink" variant="outline-info">
                                Go to Detail
                            </Button>
                        </Link>
                    )}
